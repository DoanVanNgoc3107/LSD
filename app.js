...
(function () {
    ...
    const QUESTIONS = [
        ...
        { id: 38, question: "Hoàn cảnh nước ta sau Cách mạng tháng Tám thường được mô tả là:", options: ["Không tiền, không đồng minh, không vũ khí", "Vận mệnh dân tộc như ngàn cân treo sợi tóc", "A và B đều đúng", "A và B đều sai"], correctIndex: 2 },
        ...
        { id: 72, question: "Đại hội nào chủ trương coi nông nghiệp là mặt trận hàng đầu?", options: ["Đại hội III (1960)", "Đại hội IV (1976)", "Đại hội V (1982)", "B và C đều đúng"], correctIndex: 3 },
